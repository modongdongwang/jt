...
public class OrderServiceImpl implements DubboOrderService {
	...
	public String insertOrder(Order order) {
		...
		//4.入库订单商品: 1.自己遍历集合分别入库2.自己编辑sql语句批量入库
	...
	public Order findOrderById(String id) {
		...
		List<OrderItem> selectList = orderItemMapper.selectList(queryWrapper);
		order.setOrderShipping(shipping).setOrderItems(selectList);
		return order;
	}
